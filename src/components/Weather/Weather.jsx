                    ...
                    <Card.Body>
                        ...
                        <Card.Text as={'div'} className={styles.weather_infos}>
                            ...
                            <div className={styles.temperature}>
                                <div>{weather.main.feels_like} {weather.dataUnit === 'metric' ? 'C' : 'F'}</div>
                                <div>
                                    <Thermometer />
                                </div>
                            </div>
                            ...
                            <div className={styles.infos}>
                                ...
                                <div className={styles.border_right}>
                                    <div><Wind /></div>
                                    <div>Wind</div>
                                    <div>{weather.wind.speed} {weather.dataUnit === 'metric' ? 'm/s' : 'mph'}</div>
                                </div>
                                <div className={styles.border_right}>
                                ...
                                <div>
                                    ...
                                    <div>Temp</div>
                                    <div>{weather.main.temp_max} {weather.dataUnit === 'metric' ? 'C' : 'F'}</div>
                                </div>
                            </div>
